...
<body>
	<form>
	    <?php
    		if (empty($_GET)) 
    		{
    			echo '<span>Perioada verificata (15 zile incepand cu) <input type="date" id="start" name="start_day" value="'. date("Y-m-d") .'" min="" max="2019-12-31"></span>';
    		}
    		else
    		{
    			$start_day = $_GET['start_day'];
    			echo '<span>Perioada verificata (15 zile incepand cu) <input type="date" id="start" name="start_day" value="'. $start_day .'" min="" max="2019-12-31"></span>';
    		}
    	?>
		<input type="submit" name="" value="executa" >
	</form>
	<table>
  	<tr>
    	<th>Cam/Zi</th>
